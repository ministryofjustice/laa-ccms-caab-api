...
public class ScopeLimitationControllerIntegrationLocalTest
    extends BaseScopeLimitiationControllerIntegrationTest {

  //this runs all tests in BaseScopeLimitiationControllerIntegrationTest, do not add anything here
