...
public class EvidenceControllerIntegrationTest extends BaseEvidenceControllerIntegrationTest implements
    IntegrationTestInterface {

    //this runs all tests in BaseEvidenceControllerIntegrationTest, do not add anything here
