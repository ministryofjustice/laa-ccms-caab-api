...
public class CaseOutcomeControllerIntegrationLocalTest extends BaseCaseOutcomeControllerIntegrationTest {
  ...
  //this is an easy way to run the tests if you have the containerised database running locally already
    //Here seq error select xxccms_cost_award_s.nextval
