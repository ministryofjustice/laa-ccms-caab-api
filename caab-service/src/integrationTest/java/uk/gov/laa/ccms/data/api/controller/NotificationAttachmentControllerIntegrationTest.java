...
public class NotificationAttachmentControllerIntegrationTest extends BaseNotificationAttachmentControllerIntegrationTest implements
    IntegrationTestInterface {

  //this runs all tests in BaseNotificationAttachmentControllerIntegrationTest, do not add anything here
