...
public class NotificationAttachmentControllerIntegrationTest extends AbstractControllerIntegrationTest  {
  ...
  public void testCreateNotificationAttachment() throws Exception {
    ...
    EntityExchangeResult<Void> responseEntity = restClient.post()
        .uri("/notification-attachments").body(notificationAttachmentDetail)
        .exchange()
        .expectStatus()
        .isCreated()
    ...
    assertAuditTrail(savedNotificationAttachmentDetail.getAuditTrail(), caabUserLoginId);
